...
from .views import index, signup, signin, logout, settings, upload, like_post, profile, follow, search, delete, advanced, privacy, followers, following, add_comment, like_list
